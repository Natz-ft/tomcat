package com.inspur.data.portal.layout.uc.security;
...
public class Default implements ViewHandler {
	public void execute(HttpServletRequest request, HttpServletResponse response)
		...
		if(session.getAttribute("uid") == null 
			...
			request.setAttribute("title", "安全中心-用户中心");
			...
			//获取用户积分
//			Map<String,Object> userScore = TCUtils.getScoreDomain().getUserScoreInfo(session.getAttribute("uid").toString());
			request.setAttribute("userScore", "");
		}
	}
