 ...
 */
/* ========================================================
 * Updated by liulingling @ 2016-05-23
 * 1、去除了拖拽选择文件
 * 2、重写、并增加依赖的样式到jquery.plupload.bs3.css
 * 3、btn class 改为m-btn
 * ========================================================
 */
                ...
                '<div class="plupload_container">' +
                    '<div class="plupload_choose">' +
                        '<div class="plupload_choice">' +
                            ...
                            '<button class="m-btn btn-info plupload_button_choice">' + _("Select files") + '</button>' +
                        '</div>' +
                    ...
                    '<div class="plupload_buttons">' +
                        '<div class="pull-left">' +
                            '<a class="m-btn btn-success plupload_button_start"><i class="glyphicon glyphicon-circle-arrow-right"></i>&ensp;' + _("Start Upload") + '</a>' +
                            '<a class="m-btn btn-default plupload_button_stop hidden"><i class="glyphicon glyphicon-minus-sign"></i>&ensp;' + _("Stop Upload") + '</a>' +
                            /*'<a class="m-btn btn-info plupload_button_add"><i class="glyphicon glyphicon-plus-sign"></i>&ensp;' + _("Add Files") + '</a>' +*/
                        '</div>' +
                        '<div class="btn-group plupload_view_switch pull-right" data-toggle="buttons">' +
                            '<label class="m-btn btn-default"  for="'+obj.id+'_view_thumbs" data-view="thumbs">' +
                                '<input type="radio" id="'+obj.id+'_view_thumbs" name="view_mode_'+obj.id+'" autocomplete="off" />' +
                                '<i class="fa fa-picture-o"></i>' +
                                '<span class="sr-only">' + _('Thumbnails') + '</span>' +
                            '</label>' +
                            '<label class="m-btn btn-default" for="'+obj.id+'_view_list" data-view="list">' +
