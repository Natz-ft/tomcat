		...
		if(result.code == "0000"){
			...
			*/
			...
			if(typeof upload_type != "undefined" && upload_type == "rc"){
				$("#"+this.customSettings.showTarget).html("<img src='"+rcservice_url+result.docid+"&type=thumbnail' style='width: auto; height: 64px;'/>");
