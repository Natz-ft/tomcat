        ...
        return this.each(function () {
            ...
            function showSuggestions(el, key) {
                ...
                for (i = 0; i < currentTags.length && i < workingTags.length; i++) {
                    if (!tagSelected && 
                        currentTags[i].toUpperCase() != workingTags[i].toUpperCase()) {
                        currentTag = { position: i, tag: workingTags[i].toUpperCase() };
                        tagSelected = true;
                    }
                    // lookup for filtering out chosen tags
                    chosenTags[currentTags[i].toUpperCase()] = true;
                }
                ...
                if (currentTag.tag) {
                    ...
                    matches = $.grep(matches, function (v, i) {
                        return !chosenTags[v.toUpperCase()];
                    });
                    ...
                    for (i = 0; i < matches.length; i++) {
                        html += '<' + settings.tagWrap + ' tag_id="' + matches[i].split("&&")[0] + '" class="_tag_suggestion">' + matches[i].split("&&")[1] + '</' + settings.tagWrap + '>';
                    }
            ...
            function chooseTag(tag) {
                ...
                for (i = 0; i < currentTags.length; i++) {
                    if (currentTags[i].toUpperCase() != workingTags[i].toUpperCase()) {
                        index = i;
                        break;
                    }
                }
