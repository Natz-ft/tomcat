		...
		success: function(data) {
			if(data!=""&&data!=null&&!isEmptyObject(data)){
				...
				for (var i = 0; i < data.records.length; i++) {
					...
					var upDateTime = date.getFullYear()+"年"+date.getMonth()+1+"月"+date.getDay()+"日";
					dataarr.push("<li><div class='sd_listcontent'><img src="+logo+" width='62' alt='' /><div class='sd_contop'><div class='sd_contopleft'" + "<a onclick='toappinfo("+ obj.app_id +")'>" + obj.object_name + "<a/>" + "<span class='sd_constar-1'><em></em></span></div></div><div class='sd_conmiddle'><div class='sd_conmiddleleft'>");
				...
				$("#Pagination").empty();
				dialog.info('没有数据',function(){},2000);
			}
		},
		error: function(data) {
