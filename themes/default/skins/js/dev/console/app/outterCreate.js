...
//			if(!(/^[0-9]{1,5}$/.test(version_no) && parseInt(version_no) > 0)){
//				layer.tips("版本号应为大于0的整数且范围在1-99999", $("#version_no"), 2);
//				return;
//			}
			var r = /^\d+(\.\d+)?$/;
