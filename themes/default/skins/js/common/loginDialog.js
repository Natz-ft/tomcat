...
function UCLoginDialog(config) {
    ...
    this.loginAction = this.config.ucweb + '/uc/login/Login.do?method=login';
    this.verifyImg = this.config.ucweb + '/index/verify.htm';
    this.signUp = this.config.ucweb + '/index/signup.htm';
    this.web_getpwd = this.config.ucweb + '/password/getPwd.htm';
    this.weibobtn = this.config.ucweb + '/img/login/weibobtn.png';
    this.qqbtn = this.config.ucweb + '/img/login/qqbtn.png';
    ...
    this.dlgHtml = [
    		...
    		'<img class="reginBtn" id="reginbutton" onclick="reginbtn()" style="margin-top:0px"/>',
