...
var dialog = {
    poplayer: function(option) {
        ...
        switch(config.type) {
            case "info":
                wrapper = $(
                    '<div class="modal'+ _animeClass +' bs-example-modal-sm" tabindex="-1" role="dialog" aria-hidden="true">' +
            ...
            case "loading":
                wrapper = $(
                    '<div class="modal'+ _animeClass +'" tabindex="-1" role="dialog" aria-hidden="true">' +
            ...
            default:
                wrapper = $(
                    '<div class="modal'+ _animeClass +'" tabindex="-1" role="dialog" aria-labelledby="DialogLabel" aria-hidden="true">'+
        ...
        if(otype(config.buttons) === "array") {
            ...
            for(var i in config.buttons) {
                ...
                if(otype(btn.click) === "string") {
                    if(btn.click === "yes") {
                        $btn = $('<button type="button" class="btn btn-yes">'+ btn.text +'</button>');
                    } else if(btn.click === "no") {
                        $btn = $('<button type="button" class="btn btn-no" data-dismiss="modal">'+ btn.text +'</button>');
                    } else {
                        $btn = $('<button type="button" class="btn">'+ btn.text +'</button>');
                    }
                } else if(otype(btn.click) === "function") {
                    $btn = $('<button type="button" class="btn btn-callback-'+ i +'">'+ btn.text +'</button>');
                }
    ...
    loading: function(option) {
        ...
        var _inAnime = true;
        var _content = '<img class="modal-loading" alt="loading" src="'+(Home_Url || '')+'/images/loading/loading_'+opt.type+'.gif" />';
        if(opt.text) {
            _content =
                '<div class="modal-body">'+
