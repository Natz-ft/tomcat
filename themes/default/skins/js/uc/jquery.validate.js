			...
			.extend(
					$.validator,
					{
						...
						messages : {
							...
							equalToNum : "Please enter the valid number again.",
							maxlength : $.validator
						...
						methods : {
							...
							email : function(value, element) {
								...
								return this.optional(element)
										|| /^([a-zA-Z0-9]+[_|\_|\.]?)*[a-zA-Z0-9]+@([a-zA-Z0-9]+[_|\_|\.]?)*[a-zA-Z0-9]+\.(?:com|cn)$/i.test(value);
							},
							...
							equalTo : function(value, element, param) {
								...
								var target = $(param);
//								var target = ${verify};
//								var num = document.getElementById('checknum_per');
...
//								return value === target;
							...
							equalToNum : function(value, element, param) {
								var target = $(param);
								if (this.settings.onfocusout) {
									target.unbind(".validate-equalTo").bind(
											"blur.validate-equalTo",
							...
							// 自定义的扩展校验规则
							loginName_rule : function(value, element) {
								return this.optional(element)
										|| /^[a-zA-Z][a-zA-Z0-9_]{4,19}$/i
												.test(value);
							},
							password_rule : function(value, element) {
								return this.optional(element)
										|| /^[\w\W]{6,15}$/i.test(value);
							},
							phone_rule:function(value, element) {
								return this.optional(element)
								|| /^(13[0-9]|14[579]|15[0-3,5-9]|16[6]|17[0135678]|18[0-9]|19[89])\d{8}$/i.test(value)
							},
							//同时支持手机和电话
							telephone_rule:function(value,element){
								return this.optional(element)
								|| /(^(([0\+]\d{2,3}-)?(0\d{2,3})-)(\d{7,8})(-(\d{3,}))?$)|(^0{0,1}1[3|4|5|6|7|8|9][0-9]{9}$)/i.test(value);
								/*|| /((\d{11})|^((\d{7,8})|(\d{4}|\d{3})-(\d{7,8})|(\d{4}|\d{3})-(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1})|(\d{7,8})-(\d{4}|\d{3}|\d{2}|\d{1}))$)/i.test(value);*/
							},
							zip_code_rule:function(value, element) {
								return this.optional(element)
								|| /^[1-9]\d{5}(?!\d)$/i.test(value);
							},
							qq_rule:function(value,element){
								return this.optional(element) || /^[1-9]\d{4,15}$/i.test(value);
							}
						}
