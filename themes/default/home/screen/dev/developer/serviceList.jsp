...
<website:title>${regionStatistics.region_name }公共数据开放平台_API超市</website:title>
<website:style href="dist/css/commonList.css"/>
<style>
.modal-dialog{
	z-index: 1051;
}
.container .cata-filter .filter-main .filter-body .depart-list li {
    width: auto!important;
    margin-right: 10px;
}
.container .cata-filter .filter-main .filter-body .depart-list ul li:nth-child(61) {
    display: none;
}
.container .cata-filter .filter-main .filter-body .depart-list ul li:nth-child(62) {
    display: none;
}
.container .cata-filter .filter-main .filter-body .depart-list ul li:nth-child(63) {
    display: none;
}
</style>
<div class="banner" style="height: 180px;background: url('${fn:getLink('dist/img/api_banner.jpg')}') center"></div>
<div class="main">
    <div class="g-main">
                        ...
                        <div class="filter-depart-part">
                            ...
                            <div class="depart-list">
                              <ul>
                                ...
                                <div class="depart-first"  id="H-N-title">H-N</div>
...
<!-- <script>
    window.onload = function() {
        if($("#H-N")[0].innerText == '') {
            $("#H-N-title").css({"display": "none"})
        }else {
            $("#H-N-title").css({"display": "inline-block"})
        }
    }
</script> -->
