		   ...
		   <div class="right_top"> 服务详情</div>
				<table class="applytable" border="0" cellspacing="0">
					...
					<tr>
						...
						<td class="lefttd" style="width: 100px;">所属应用：</td>
						<td>${apply.app_name}</td>
					</tr>
					<tr>
						<td class="lefttd" width="70px">联系人：</td><td>${apply.name}</td>
						<td class="lefttd" width="70px">联系方式：</td><td>${apply.tel}</td>
					</tr>		
				<tr><td class="lefttd">使用时间:</td><td colspan="3">${apply.start}&nbsp;&nbsp;至&nbsp;&nbsp;${apply.end}</td></tr>
				<tr><td class="lefttd">使用级别:</td><td colspan="3">
					<div class="level_div">
				...
				<tr style="line-height:10;"><td class="lefttd">申请事由:</td><td colspan="3">${apply.subscription_reason}</td></tr>
			</tbody></table>
		  </div>
	</div>
