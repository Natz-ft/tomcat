...
<website:title>${regionStatistics.region_name }公共信息资源开放平台_关联服务</website:title>
...
<div class="sjtp_detail">
	<div class="buttons">
		<div class="btn_relnet">
			...
			<div class="btn_detail" id="wangluotp">
				<div class="btn_title ico_data data_on" id="tags">
					<div class="btn_txt" title="数据标签" style="font-size: 12px;">数据标签</div>
				</div>
			</div>
			<div class="btn_detail" id="fenbutp">
				<div class="btn_title ico_data" id="dataset">
					<div class="btn_txt" style="font-size: 12px;">数据集</div>
				</div>
			</div>
	...
	<div class="sjtp_right">
		...
		<div class="right_title">数据集/关键词筛选</div>
		<div class="right_main">
			...
			<div class="right_list">
				...
				<div id="relalist">
					...
					<div class="right_page pagination"></div>
				</div>
				<div id="searchlist">
					<ul>
					</ul>
