      ...
      <!--  <div class="m_warn" style="margin-right:0px;margin-top:10px;border:1px solid #FF0000;background:#FFE2CF;color:#FFf0000">
        ...
        <div class="form-body form-signup-body">
          ...
          <dl>    
            ...
            <dd class="form-tip"></dd>
            <dd class="check_rule"><a id="send_code" onclick="phoneClick()">发送验证码</a></dd>
          </dl>
            <dl>
            <dt>
              <em>*</em>&nbsp;手机验证码：
      ...
      <!--  <div class="m_warn" style="margin-right:0px;margin-top:10px;border:1px solid #FF0000;background:#FFE2CF;color:#FFf0000">
        ...
        <div class="form-body form-signup-body">
          <dl>    
            ...
            <dd>
              <input id="user_id" class="input" name="user_id" type="text"/>
            </dd>
            <dd class="form-tip"></dd>
            <dd class="check_rule">以字母开头，允许使用字母数字下划线，5-20位组成</dd>
          </dl>
          ...
          <dl>    
            ...
            <dd class="form-tip"></dd>
            <dd class="check_rule">请输入企业联系电话</dd>
          </dl>
          <dl>    
            <dt>
              <em>*</em>统一社会信用码：
          ...
          <dl  class="check-box">    
            ...
            <span>
              <input type="checkbox" name="optionsRadios" id="optionsRadios_org1" value="1" > 教育
              <input type="checkbox" name="optionsRadios" id="optionsRadios_org2" value="2" > 旅游
              <input type="checkbox" name="optionsRadios" id="optionsRadios_org3" value="3" > 工业
              <input type="checkbox" name="optionsRadios" id="optionsRadios_org4" value="4" > IT互联网
              <input type="checkbox" name="optionsRadios" id="optionsRadios_org5" value="5" > 房地产
              <input type="checkbox" name="optionsRadios" id="optionsRadios_org6" value="6" > 制造业
              <input type="checkbox" name="optionsRadios" id="optionsRadios_org7" value="7" > 交通物流
            </span>
            <span class="check-box"  style="display:block">
              <input type="checkbox" name="optionsRadios" id="optionsRadios_org8" value="8" > 政府
              <input type="checkbox" name="optionsRadios" id="optionsRadios_org9" value="9" > 贸易
              <input type="checkbox" name="optionsRadios" id="optionsRadios_org10" value="10" > 文化娱乐
              <input type="checkbox" name="optionsRadios" id="optionsRadios_org11" value="11" > 农林渔牧业
              <input type="checkbox" name="optionsRadios" id="optionsRadios_org12" value="12" > 体育艺术
              <input type="checkbox" name="optionsRadios" id="optionsRadios_org13" value="13" > 其他
            </span>
          </dl>
        </div>
...
<script type="text/javascript">
  ...
  function phoneClick(){
    var phoneNum_input = $("#login_phone").val();
  ...
  function phoneSettime(){
    ...
    $("#verifyOK_org").css("color","gray");
    $("#verifyOK_org")[0].firstChild.nodeValue = "请输入短信验证码";
    phoneTimedown = 60; 
    //清除session
    $.ajax({
      type : "POST",
