			...
			<!-- 	<div class="m_warn" style="margin-right:0px;margin-top:10px;border:1px solid #FF0000;background:#FFE2CF;color:#FFf0000">
				...
				<div class="form-body form-signup-body">
					<dl>
						...
						<dd>
							<input id="login_phone" class="input" name="login_phone" type="text" onfocus="phonefocus()" onblur="phoneblur()"/>
						</dd>
						<dd class="form-tip"></dd>
					...
					<dl>
						...
						<dd>
							<input id="login_name_per1" name="login_name" type="text"
								class="input" />
						</dd>
						<dd class="form-tip" ></dd>
						<dd class="check_rule">以字母开头，允许使用字母数字下划线，5-20位组成</dd>
					...
					<dl>
						...
						<dd>
							<input id="nick_per1" name="nick" type="text"
								class="input" />
						</dd>
						<dd class="form-tip"></dd>
						<dd class="check_rule">不能超过20个字符串，汉字算一个字符</dd>
					...
					<dl style="width:640px;">
						...
						<dd>
							<input id="password_per1" name="password" type="password"
								class="input " />
						</dd>
						<dd class="form-tip" style="width:180px;line-height:20px;"></dd>
						<dd class="check_rule">密码由6-15位字母、数字或特殊符号组成</dd>
					...
					<dl>
						...
						<dd>
							<input id="confirm_password_per1" name="confirm_password"
								type="password" class="input" />
						</dd>
						<dd class="form-tip"></dd>
						<dd class="check_rule">请再次输入您设置的密码</dd>
					...
					<dl style="display: none;">
						<select name="user_type" id="user_type_per1" class="select">
							<option value="11" checked="true">个人</option>
						</select>
					</dl>
					<dl>
						...
						<dd>
							<input id="checknum_per1" name="checknum" type="text"
								class="input" style="width: 100px; padding: 0px 0px 0px 2px;" />
							&nbsp <a href="javascript:changeVerify_per1();"
								hideFocus="hidefocus"> <img
								src="${fn:getLink('uc/index/verify.jsp')}"
								id="verifyImg_per1" alt="换一张" /></a>&nbsp; <a
								href="javascript:changeVerify_per1();" style="font-size: 12px;"
								hideFocus="hidefocus">看不清楚可换一个</a>
								<input id="verifycode_hid_p1" type="hidden" value="" />
						</dd>
						<dd class="form-tip"></dd>
					</dl>
		...
		<div class="form_org_contain" style="display: none;" id="form_org_contain">
			<form
				...
				<div class="form-body form-signup-body">
					...
					<dl style="display: none;">
						<select name="user_type1" id="user_type_org" class="select">
