...
<script>
var interactUrl = "${fn:getLink('interact/interact.do') }";
...
<div class="main">
 <div class="wdhd_b">
  <div class="wdhd_b1"> <b>我的互动信息</b> </div>
 </div>
<div class="wdhd_xuanxiang">
<ul id="geshichecklist">
<li  class="current"><a  id="interact_all" style="padding-left:15px; padding-right:15px; display: block;">全部</a></li>
<li><a id="interact_msg" style="padding-left:15px; padding-right:15px; display: block;" >留言</a></li>
<li><a id="interact_request" style="padding-left:15px; padding-right:15px; display: block;">申请</a></li>
<li><a id="interact_suggest" style="padding-left:15px; padding-right:15px; display: block;">建议</a></li>
</ul>
</div> 
...
<div class="ly_ym">
	<div align="center">
		<div id="Pagination" class="pagination" style="margin-left:270px;"></div>
	</div>
</div>
 </div>
