...
<website:script src="${ucweb}/js/uc/common/template.js"/>
<website:script src="${ucweb}/js/uc/common/loginDialog.js" />
...
<div class="header">
    <div class="g-main">
        <a href="${odweb }/index.htm" class="header-logo">
            <img src="${ucweb}/img/uc/common/logo.png"/>
            <img src="${ucweb}/img/uc/common/logo_title.png"/>
