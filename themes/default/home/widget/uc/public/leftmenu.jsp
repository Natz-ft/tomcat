...
<div class="kfz_left">
	<div class="kfz_user">
		<div class="kfz_head">
				<c:if test="${sessionScope.userInfo.avatar==null}"><a href="${fn:getConfValue('global.index.odweb')}/uc/account/accountPhoto.htm"><img src="${fn:getLink('/img/uc/index/userhead.jpg')}" alt=""></a></c:if>
				<c:if test="${sessionScope.userInfo.avatar!=null}"><a href="${fn:getConfValue('global.index.odweb')}/uc/account/accountPhoto.htm"><img src="${sessionScope.userInfo.avatar}" alt=""></a></c:if>
		</div>
...
<%-- 				<li id="mystatis"><a href="${fn:getConfValue('web_data')}/home/index.jsp"> <i class="icon icon005"></i>我的统计
		...
		<div class="kfz_menudetail" id="detail3">
			<ul class="kfz_menulist">
			<c:if test="${sessionScope.developer_id == null || sessionScope.developer_id == ''}">
				<li id="developerid"><a href="${fn:getConfValue('global.index.odweb')}/console/developer.htm"> <i class="icon icon15"></i>注册成为开发者
				</a></li>
			</c:if>
				<li id="personinfo"><a href="${fn:getConfValue('global.index.odweb')}/uc/account/account.htm"> <i class="icon icon15"></i>个人资料
				</a></li>
				<li id="accountphoto"><a href="${fn:getConfValue('global.index.odweb')}/uc/account/accountPhoto.htm"> <i class="icon icon13"></i>头像设置
				</a></li>
				<li id="bind"><a href="${fn:getConfValue('global.index.odweb')}/uc/account/accountBind.htm"> <i class="icon icon18"></i>外部绑定
				</a></li>
			</ul>
		</div>
		<div class="kfz_menutitle" id="title3">
		...
		<div class="kfz_menudetail" id="detail3">
			<ul class="kfz_menulist">
				...
				<li id="secemail"><a href="${fn:getConfValue('global.index.odweb')}/uc/security/secBindMailW.htm"> <i class="icon icon23"></i>安全邮箱
				</a></li>
				<li id="pwdques"><a href="${fn:getConfValue('global.index.odweb')}/uc/security/secAsk.htm"> <i class="icon icon24"></i>密保问题
				</a></li>
			</ul>
		</div>
	</div>
