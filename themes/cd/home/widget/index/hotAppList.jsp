            ...
            <div class="app-list">
                <ul>
                    <c:forEach var="appInfo" items="${hotAppList}">
                    	<li>
	                        <a href="${fn:getLink('appcenter/detail.htm') }?app_id=${appInfo.app_id}" target="_blank">
	                            <div class="left-part">
...
<div class="data-block">
		<div class="data-title-container">
			<div class="title-name app-more">热门应用</div>
			<div class="title-more "><a href="${fn:getLink('/appcenter/index.htm')}">更多</a></div>
		</div>
		<ul class="app-list">
			<c:forEach var="appInfo" items="${hotAppList}">
				<li>
