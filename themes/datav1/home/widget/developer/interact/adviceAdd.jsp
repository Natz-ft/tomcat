		...
		<ul style="margin-left: 100px;">
			<li>
				<div class="list_coladvice" style="margin-top: 20px;">
					<span class="titleSpan">标题：</span> <input type="text"
						name="advice_title" id="advice_title"
			...
			<li>
				<div class="list_coladvice">
					...
					<textarea id="advice_desc" name="advice_desc" rows="5" cols="50"
		...
		var options = {
				...
				beforeSubmit: function(data){
					for(var i in data){
						...
						var phone_format = /(^[0-9]{3,4}\-[0-9]{7,8}$)|(^[0-9]{7,8}$)|(^\([0-9]{3,4}\)[0-9]{3,8}$)|(^0{0,1}13[0-9]{9}$)/;
