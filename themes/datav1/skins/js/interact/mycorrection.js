						...
						if(typeof(datas.code) != "undefined"){
							...
							if (datas != "" && datas != null) {
								...
								for (var i = 0; i < datas.data.length; i++) {
									...
									text += '<div class="n1"><p><span style="font-style: italic; color: #6BB1F7; width:300px;">' + obj.object_title + '   </span>';
									text += obj.content + '</p><div>';
									text += obj.object_url;
	//								text += '<a style="float:right" href="javascript:adviceDelete()">';
	//								text += '<img src="/v0.1/img/interact/hd_x.png"></a>';
									text += '</div>'+obj.create_Time+'</div>';
