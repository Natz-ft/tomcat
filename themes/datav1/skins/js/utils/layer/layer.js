...
pathUrl = 'ac2/layer/', //上述变量为false才有效，当前layerjs所在目录(不用填写host，相对站点的根目录即可)。
*/
var pathType = true,
pathUrl = '',
...
window.layer = {
    ...
    ready: function(callback){
        return layer.use('js/util/layer/skin/layer.css', callback);
    }, 
...
ready.run = function(){
    $ = jQuery; 
    win = $(window);
    layer.use('js/util/layer/skin/layer.css');
